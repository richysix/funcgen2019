...
2. Find out which gene has the smallest pvalue by sorting the data using `arrange`.
...
3. Make a new column in the data that is -log10 of the adjusted pvalue column. 
...
```{r gather, echo = FALSE}
normalised_counts_long <- 
  gather(normalised_counts, -GeneID, -Name,
